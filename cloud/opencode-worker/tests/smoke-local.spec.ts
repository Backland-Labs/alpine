...
test.describe('Local smoke test', () => {
  test('should load OpenCode UI from local Worker', async ({ page }) => {
    ...
    console.log(`Visiting local URL: ${url}`);
    ...
    const screenshotPath = path.resolve(__dirname, '../../../artifacts/screenshots/local-ui.png');
